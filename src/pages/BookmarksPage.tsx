...
import {
  ...
  Bookmark, Share, MoreHorizontal, Zap, Trash2
} from 'lucide-react';
...
const initialBookmarks = [
  {
    ...
    content: '🚨 BREAKING: Real Madrid are closing in on a summer deal. More details dropping in the next hour. #TransferNews',
    time: '3h ago', likes: 5621, comments: 892, reposts: 1203, tag: 'Transfers',
  },
  {
    id: 'b2',
    user: { name: 'UCL King', handle: '@uclking', verified: true, tipster: true },
    content: 'Champions League quarterfinals preview: Bayern vs Real Madrid is the tie of the round. Both teams in brilliant form ⚽🏆',
    time: '5h ago', likes: 2341, comments: 445, reposts: 312, tag: 'UCL',
  },
  {
    id: 'b3',
    user: { name: 'NBA Central', handle: '@nbacentral', verified: true, tipster: true },
    content: 'LeBron at 39 years old still dropping 30 points a night is the most impressive thing in sports history 🏀',
    time: '1d ago', likes: 8921, comments: 1234, reposts: 2341, tag: 'NBA',
  },
  {
    id: 'b4',
    user: { name: 'John Pulse', handle: '@johnpulse', verified: true, tipster: true },
    content: 'Haaland is going to finish this season with 40+ goals. The man is simply not human ⚽🤖',
    time: '2d ago', likes: 3421, comments: 567, reposts: 234, tag: 'Football',
  },
];
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center justify-between text-[#71767b]">
                ...
                <button
                  onClick={() => removeBookmark(post.id)}
                  className="flex items-center gap-1 text-xs text-[#ef4444] hover:text-red-300 transition-colors"
                >
