...
// ── Setting Row ───────────────────────────────────────────────
function SettingRow({
  label, desc, toggle, value, onChange, onClick, danger
}: {
  label: string;
  desc?: string;
  toggle?: boolean;
          ...
          {activeTab === 'privacy' && (
            <div>
              ...
              <SettingRow
                ...
                toggle value={showPredictions} onChange={setShowPredictions}
              />

              <SectionHeader title="Data & Ads" />
              ...
              <SettingRow label="Data Sharing Preferences" onClick={() => {}} />
            </div>
          )}
          ...
          {activeTab === 'notifications' && (
            <div>
              ...
              <SettingRow
                ...
                toggle value={matchAlerts} onChange={setMatchAlerts}
              />
              <SettingRow
                label="Prediction Results"
                desc="When your followed tipsters post results"
                toggle value={predictionResults} onChange={setPredictionResults}
              />
              <SettingRow
                label="New Followers"
                desc="When someone follows you"
                toggle value={newFollowers} onChange={setNewFollowers}
              />
              <SettingRow
                label="Mentions & Replies"
                desc="When someone mentions or replies to you"
                toggle value={mentions} onChange={setMentions}
              />
              <SettingRow
                label="Messages"
                desc="New direct messages"
                toggle value={messages} onChange={setMessages}
              />
          ...
          {activeTab === 'display' && (
            <div>
              ...
              <SettingRow
                ...
                toggle value={autoplayVideos} onChange={setAutoplayVideos}
              />
              <SettingRow
                label="Reduce Motion"
              ...
              <SettingRow label="Content Language" desc="English" onClick={() => {}} />
            </div>
          )}
              ...
              <div className="px-4 py-3 border-b border-[#1f1f1f]">
                <div className="flex items-start gap-3 p-3 bg-[#ef4444]/5 border border-[#ef4444]/20 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-[#71767b] mt-0.5 mb-2">This action is permanent and cannot be undone. All your data will be deleted.</p>
