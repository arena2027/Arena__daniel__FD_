...
const transactions = [
  ...
  { id: 't7', type: 'credit', desc: 'Deposit via USSD', amount: 3000, time: '1w ago', status: 'success' },
              ...
              <div className="bg-gradient-to-br from-[#ef4444] to-[#b91c1c] rounded-2xl p-6 text-white">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 flex items-center justify-center gap-2 bg-white/20 hover:bg-white/30 rounded-xl py-2.5 text-sm font-bold transition-all"
                  >
